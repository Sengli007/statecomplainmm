                ...
                <div class="col-xs-12">
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="mainmenu">
                        ...
                        <ul class="nav navbar-nav primary-menu">
                            <li><a href="{{route('/')}}">ပင်မစာမျက်နှာ</a></li>
					...
					<div class="container-login100">
                        ...
                        @endif
							<form class="login100-form validate-form" action="{{route('auth.login')}}" method="post">
								...
								<div class="wrap-input100 validate-input m-b-20" data-validate="အီးမေးလ် လို‌‌‌နေပါသည် !">
									<input class="input100" type="text" name="email" placeholder="အီးမေးလ်">
									<span class="focus-input100"></span>
								</div>

								<div class="wrap-input100 validate-input m-b-25" data-validate = "လျှို့ဝှက်နံပါတ် လို‌‌‌နေပါသည် !">
									<input class="input100" type="password" name="password" placeholder="လျှို့ဝှက်နံပါတ်">
									<span class="focus-input100"></span>
								</div>

								<div style="float:right;margin-bottom:10px;">
									<a href="#">လျှို့ဝှက်နံပါတ်မေ့လျှင်</a>
								</div>
